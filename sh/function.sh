...
###########################################################
install_nghttp2(){
#yum -y install jansson-devel           #configure: No package 'jansson' found 和nghttp2冲突     #nghttp2  https://github.com/nghttp2/nghttp2/releases

if [ ! -d /usr/local/nghttp2  ];then
nghttp2version=nghttp2-1.39.2
cd ~
...
install_fileinfo() {
  src_url=https://www.php.net/distributions/php-7.3.4.tar.gz && Download_src
